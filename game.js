...
const quotes_array=document.querySelector(".quote")
...
function myFunction1() {
  ...
  TIME_LIMIT = document.getElementById("time").innerHTML;
}
function myFunction2() {
  document.getElementById("time").innerHTML = "50";
  TIME_LIMIT = document.getElementById("time").innerHTML;
}
...
function updateQuote() {
  ...
  if (quoteNo < current_quote.length - 1)
    quoteNo++;
  else
    quoteNo = 0;
}
...
function processCurrentText() {
  ...
  if (curr_input.length == quote_length) {
...
function startGame() {
  ...
  resetValues();
  current_quote="Welcome to Simple Speed Typing.";
